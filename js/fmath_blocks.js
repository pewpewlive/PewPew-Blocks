...
Blockly.Blocks["fmath_max_fixedpoint"] = {
  init: function () {
    this.appendDummyInput().appendField("max fixedpoint")
    this.setOutput(true, "Fixedpoint")
    this.setColour(230)
...
Blockly.Blocks["fmath_sqrt"] = {
  init: function () {
    this.appendValueInput("x").setCheck("Fixedpoint").appendField("square root of:")
    this.setOutput(true, "Fixedpoint")
    this.setColour(230)
...
Blockly.Blocks["fmath_to_int"] = {
  init: function () {
    this.appendValueInput("value").setCheck("Fixedpoint").appendField("to int:")
...
Blockly.Blocks["fmath_arithmetic"] = {
  init: function () {
    this.appendValueInput("A").setCheck("Fixedpoint")
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_CENTRE)
      .appendField(
    ...
    this.appendValueInput("B").setCheck("Fixedpoint").setAlign(Blockly.ALIGN_RIGHT)
    this.setInputsInline(true)
    this.setOutput(true, "Fixedpoint")
    this.setColour(230)
    this.setTooltip("")
...
Blockly.Blocks["fmath_modulo"] = {
  init: function () {
    ...
    this.appendValueInput("DIVIDEND").setCheck("Fixedpoint")
    this.appendDummyInput().appendField("÷")
    this.appendValueInput("DIVISOR").setCheck("Fixedpoint")
    this.setInputsInline(true)
    this.setOutput(true, "Fixedpoint")
    this.setColour(230)
    this.setTooltip("")
...
Blockly.Blocks["fmath_tau"] = {
  init: function () {
    this.appendDummyInput().appendField("τ")
    this.setInputsInline(true)
    this.setOutput(true, "Fixedpoint")
    this.setColour(230)
