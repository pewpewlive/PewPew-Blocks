...
Blockly.Blocks["pewpew_print_debug_info"] = {
  init: function () {
    this.appendDummyInput().appendField("print debug info")
    this.setPreviousStatement(true, null)
    this.setNextStatement(true, null)
    this.setColour(180)
    this.setTooltip(
...
Blockly.Blocks["pewpew_set_level_size"] = {
  init: function () {
    this.appendDummyInput().appendField("set level size")
...
Blockly.Blocks["pewpew_add_update_callback"] = {
  init: function () {
    this.appendDummyInput().appendField("add update callback")
    this.appendStatementInput("fun").setCheck(null)
    this.setColour(230)
...
Blockly.Blocks["pewpew_configure_player"] = {
  init: function () {
    this.appendDummyInput().appendField("configure player")
...
Blockly.Lua["pewpew_configure_player"] = function (block) {
  ...
  var value_camera_x_override = Blockly.Lua.valueToCode(
    block,
    "camera_x_override",
    Blockly.Lua.ORDER_ATOMIC
  )
  var value_camera_y_override = Blockly.Lua.valueToCode(
    block,
    "camera_y_override",
    Blockly.Lua.ORDER_ATOMIC
  )
  var value_camera_distance = Blockly.Lua.valueToCode(
    block,
    "camera_distance",
    Blockly.Lua.ORDER_ATOMIC
  )
  var value_camera_rotation_x_axis = Blockly.Lua.valueToCode(
    block,
    "camera_rotation_x_axis",
    Blockly.Lua.ORDER_ATOMIC
  )
  var value_move_joystick_color = Blockly.Lua.valueToCode(
    block,
    "move_joystick_color",
    Blockly.Lua.ORDER_ATOMIC
  )
  var value_shoot_joystick_color = Blockly.Lua.valueToCode(
    block,
  ...
  value_camera_rotation_x_axis
    ? codeArray.push(`camera_rotation_x_axis = ${value_camera_rotation_x_axis},`)
    : null
  value_move_joystick_color
    ? codeArray.push(`move_joystick_color = ${value_move_joystick_color},`)
    : null
  value_shoot_joystick_color
    ? codeArray.push(`shoot_joystick_color = ${value_shoot_joystick_color},`)
    : null
  codeArray.push("})\n")
...
Blockly.Blocks["pewpew_new_player_ship"] = {
  init: function () {
    this.appendDummyInput().appendField("new player ship")
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("player index:")
      .appendField(new Blockly.FieldNumber(0, 0, 1), "player_index")
...
Blockly.Blocks["pewpew_configure_player_ship_weapon"] = {
  init: function () {
    this.appendDummyInput().appendField("configure ship weapon")
...
Blockly.Lua["pewpew_configure_player_ship_weapon"] = function (block) {
  var value_weapon_config = Blockly.Lua.valueToCode(
    block,
    "weapon_config",
    Blockly.Lua.ORDER_ATOMIC
  )
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          ["1 Hz", "pewpew.CannonFrequency.FREQ_1"],
          ["2 Hz", "pewpew.CannonFrequency.FREQ_2"],
          ["3 Hz", "pewpew.CannonFrequency.FREQ_3"],
          ["5 Hz", "pewpew.CannonFrequency.FREQ_5"],
          ["6 Hz", "pewpew.CannonFrequency.FREQ_6"],
          ["7.5 Hz", "pewpew.CannonFrequency.FREQ_7_5"],
          ["10 Hz", "pewpew.CannonFrequency.FREQ_10"],
          ["15 Hz", "pewpew.CannonFrequency.FREQ_15"],
          ["30 Hz", "pewpew.CannonFrequency.FREQ_30"],
        ]),
        "frequency"
      )
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          ...
          ["tic-toc", "pewpew.CannonType.TIC_TOC"],
          ["double", "pewpew.CannonType.DOUBLE"],
          ["four directions", "pewpew.CannonType.FOUR_DIRECTIONS"],
          ["double swipe", "pewpew.CannonType.DOUBLE_SWIPE"],
...
Blockly.Lua["weapon_config"] = function (block) {
  ...
  else var code = `{frequency = ${dropdown_frequency}, cannon = ${dropdown_cannon}}`
